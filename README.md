...
| File | Use it if |
|---|---|
| **`AI.Usage.Widget.Setup.1.0.0.exe`** | You want it installed — creates Start Menu and desktop shortcuts. Per-user, so no admin prompt. |
| **`AI.Usage.Widget.1.0.0.exe`** | You just want to try it. Portable, installs nothing. |
